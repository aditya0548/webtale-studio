  ...
  return (
    <div className="hidden md:block fixed left-[48px] top-0 w-[1px] h-[100vh] z-50 pointer-events-none">
      ...
      <div
        ...
        style={{ background: "rgba(125,40,64,0.12)" }}
      />
      ...
      <div
        ...
        style={{
          height: `${progress * 100}%`,
          background: "linear-gradient(to bottom, transparent, #7d2840, #c0392b, #7d2840, transparent)",
          boxShadow: "0 0 8px rgba(192,57,43,0.8), 0 0 16px rgba(125,40,64,0.4)",
      ...
      >
        ...
        <div
          ...
          style={{
            background: "#c0392b",
            boxShadow: "0 0 12px rgba(192,57,43,1), 0 0 24px rgba(192,57,43,0.6)"
          }}
        />
      </div>
    </div>
